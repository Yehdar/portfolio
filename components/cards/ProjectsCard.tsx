...
export const PROJECTS: Project[] = [
  ...
  { icon: Code2, logo: "/projects/statements.png",                name: "Credit Statement Wrapped",         description: "\"Spotify Wrapped\" credit statement analyzer", tech: "Go, Next.js (TypeScript), PostgreSQL, Gemini Flash",            href: "https://github.com/lascongress/Credit-Card-Statement-Processor"            },
