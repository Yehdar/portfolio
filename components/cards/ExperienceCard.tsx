...
export default function ExperienceCard({ desktop, expanded }: { desktop?: boolean; expanded?: boolean }) {
  ...
  return (
    <div className="w-full h-full flex flex-col overflow-hidden" style={{ background: show ? theme.rowBg : "transparent" }}>
      ...
      {show && (
        ...
        >
          <p className="text-[10px] font-bold tracking-[0.25em] uppercase mb-3" style={{ color: "rgba(255,255,255)" }}>Where I've Worked</p>
          {TRANSACTIONS.map((tx) => (
